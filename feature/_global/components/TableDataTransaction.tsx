...
export function TableDataTransaction({
  ...
  return (
    <div className="flex w-full max-w-7xl px-7 py-3 justify-center border-2 rounded-lg">
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {dataTransaction.map((d) => (
            <TableRow key={d.transactionId}>
              ...
              <TableCell>{formatRupiah(d.priceSell)}</TableCell>
              <TableCell>{formatRupiah(d.profitSell)}</TableCell>
